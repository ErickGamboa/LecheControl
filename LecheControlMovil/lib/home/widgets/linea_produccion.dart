...
class LineaProduccion extends StatelessWidget {
  const LineaProduccion({
    ...
    this.onTap,
    this.altoGrafico = altoGraficoTelefono,
  });

  /// Alto del gráfico en el teléfono: lo que queda arriba de la grilla de
  /// módulos sin empujar una tarjeta fuera de la pantalla.
  static const double altoGraficoTelefono = 104;

  final List<PuntoProduccion> puntos;
  final VoidCallback? onTap;

  /// Alto del área dibujada, sin contar el encabezado ni las fechas.
  ///
  /// En el teléfono manda el espacio y 104 px es lo que sobra. En la
  /// computadora el gráfico no compite con nada y es lo que de verdad
  /// aprovecha la pantalla —en 104 px repartidos en un monitor no se
  /// distingue una semana buena de una mala—, así que el tablero de
  /// LecheControlWeb le pasa bastante más.
